...
CREATE INDEX idx_feed_funfriday      ON feed(is_fun_friday);
...
-- Indexes for reel
CREATE INDEX idx_reel_user_id        ON reel(user_id);
CREATE INDEX idx_reel_created_at     ON reel(created_at);
...
CREATE INDEX idx_reel_like_reel_id   ON reel_like(reel_id);
CREATE INDEX idx_reel_like_user_id   ON reel_like(user_id);
...
CREATE INDEX idx_poll_vote_option_id ON poll_vote(poll_option_id);
CREATE INDEX idx_poll_vote_voter_id  ON poll_vote(voter_id);
